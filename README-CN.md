---
title: Xboard API 文档
description: Xboard VPN 管理系统完整 API 接口参考
...
- [身份验证](#-身份验证)
- [访客 API](#-访客-api公开---无需身份验证)
- [身份验证 API](#-身份验证-apipassport)
- [用户 API](#-用户-api已认证用户)
- [客户端 API](#-客户端-api客户端身份验证)
- [服务器 API](#-服务器-api服务器身份验证)
- [员工 API](#-员工-api员工身份验证)
- [管理员 API](#-管理员-api管理员身份验证)
- [说明](#-说明)
...
| 员工     | 需要员工权限                  | `员工中间件`         |
| 管理员   | 需要管理员权限                | `管理员中间件`       |
| 客户端   | 需要客户端身份验证            | `客户端中间件`       |
| 服务器   | 需要服务器身份验证            | `服务器中间件`       |
